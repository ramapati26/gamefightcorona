...
const init = () => {
    ...
    virusImg = new image();
    virusImg.src = (C:\Users\USER\Desktop\Screenshot_2020-09-06-19-52-33-85.jpg);
    lost = 0;
    kill = 0;
    life = 100;
...
cost random = (max=1, min=0) => Math.random() * (max – min) + min;

cost clear = () => ctx.clearRect(0, 0, W, H);

cost updateLost = () => document.getElementsByClassName(‘lost’)[0].innerText = lost;
cost updateKill = () => document.getElementsByClassName(‘kill’)[0].innerText = kill;
cost updateLife = () => document.getElementsByClassName(‘life’)[0].innerText = life + “%”;
...
cost newVirus = () => virus.push(new virus());
